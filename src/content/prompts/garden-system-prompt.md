---
title: Garden system prompt
date: 2026-05-06
maturity: solid
description: System prompt for the garden chatbot voice.
ai: 100% Maai
tags: [chatbot, prompts, design]
prompt_id: garden-system-prompt
prompt_version: '0.1'
...
<!--
How to add a new prompt to this library:
1. Drop a new file at src/content/prompts/<prompt-id>.md
2. Frontmatter must include prompt_id, prompt_version, prompt_category (chatbot/workflow/brainstorm), prompt_status (active/archived/draft), bot_id
3. Body is the literal prompt sent to the model. Design notes go in HTML comments like this one and are stripped at load.
4. Consumer code calls load_prompt("<prompt-id>") from api/server.py
-->
