...
type CollectionName = 'fieldNotes' | 'seeds' | 'articles' | 'weblinks' | 'videos' | 'library' | 'principles';

export async function getAllContent() {
  const [fieldNotes, seeds, articles, weblinks, videos, library, principles] = await Promise.all([
